<template>
  <div class="container">
    <hero-block :is-anchor="true" @onClick="scrollToServices">
      <template v-slot:header> Решение для магазинов </template>
      <template v-slot:description>
        <div class="description">
          <p class="article">
            Мы значительно расширяем возможности интернета. Дополнительные
            сервисы, которые вы получите с Oyster Telecom, позволят оценить все
            преимущества услуг связи, повышающие эффективность вашего бизнеса.
          </p>
          <p class="article">
            Вы можете подключить услуги комплексно и по отдельности!
          </p>
        </div>
      </template>
...
.hero-block {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)),
    url('~/static/images/backgrounds//reshenie-dlya-magazinov-i-tochek-prodazh-bg.jpg');
  .description {
    margin-bottom: 1em;
  }
}
